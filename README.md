...
[![Watch the Mimir product demo](docs/media/mimir-cover.png)](https://raw.githubusercontent.com/1692775560/Mimir/main/docs/media/mimir-demo.mp4)
...
Click the cover or link above to watch the complete product demo, including AI-assisted research, literature management, experiments, figure archiving, and paper writing. The video includes smooth zooms that highlight each workflow.
