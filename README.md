...
- `packages/mimir` — the host plugin (`dsh-mimir`): commands, tools, wiki domain, reviewer loop, LaTeX compile, BibTeX management, paper snapshots, the `research` Remote namespace (41 methods), and the `/research/pdf` / `/research/figure` / `/research/figure-upload` routes.
