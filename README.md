...
- **`dsh-mimir`** (`packages/mimir`) — the host plugin: commands, tools, wiki domain, reviewer loop, LaTeX compile, BibTeX management, and the `research` Remote namespace (24 methods) + `/research/pdf` / `/research/figure` / `/research/figure-upload` routes backing the panel.
